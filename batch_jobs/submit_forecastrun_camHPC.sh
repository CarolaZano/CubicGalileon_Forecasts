...
#! Name of the job:
#SBATCH -J config_run_baryoniccuts_k0p2_fphi1p0
...
module load fftw/
module load lua/5.3.6/gcc/c6l7paxt
module load gsl

#! Insert additional module load commands after this line if needed:

export PYTHONPATH=/home/dc-zano2/CubicGalileon_Forecasts:$PYTHONPATH
source /home/dc-zano2/CG_forecasts_env/bin/activate

#! Full path to application executable: 
application="/home/dc-zano2/CubicGalileon_Forecasts/CubicGalileonForecasts.py"

#! Run options for the application:
options="./ini_files/config_run_baryoniccuts_k0p2_fphi0p5.yaml"
